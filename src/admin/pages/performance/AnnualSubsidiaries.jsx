  ...
  return (
    <div className="section-page-container">
      <div className="section-header">
        <div>
          <h1 className="page-title">Performance <span className="subtitle">— Annual Subsidiaries</span></h1>
          <p className="page-description">Manage Subsidiaries Reports</p>
        </div>
      ...
      {showCreateModal && (<div className="modal-overlay"><div className="modal-card"><h2 className="modal-title">New Subsidiary Report</h2>{renderModalForm(false)}</div></div>)}
